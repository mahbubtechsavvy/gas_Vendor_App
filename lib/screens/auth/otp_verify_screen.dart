...
class _OtpVerifyScreenState extends State<OtpVerifyScreen> {
  ...
  void initState() {
    super.initState();
    _startTimer();
    _speechBubble = 'Check merchant email!';
    ...
    _otpController.addListener(() {
      ...
      if (len == 8 || len == 6) {
        setState(() {
          ...
          _speechBubble = 'Ready to verify partner! 🏪';
        });
      } else if (len > 0) {
        setState(() {
          _mascotMood = MascotMood.typing;
  ...
  void _verify() async {
    ...
    setState(() {
      _mascotMood = MascotMood.thinking;
      _speechBubble = 'Verifying partner credentials...';
    });
    ...
    if (success) {
      setState(() {
        ...
        _speechBubble = 'Verified! Welcome Partner 🎉';
      });
      ...
      setState(() {
        _mascotMood = MascotMood.error;
        _speechBubble = 'Invalid code! Check email.';
      });
      if (auth.error != null) {
